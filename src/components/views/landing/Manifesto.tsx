        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 animate-fade-in">
            <div className="prose prose-invert prose-cyan max-w-none">
                ...
                <blockquote className="text-xl font-light italic border-l-4 border-gray-700 pl-4 my-6 text-gray-300">
                    &quot;Does this claim move us closer to verifiable
                    truth, accountability, or material insight — or does it
                    stall, redirect, monetize, or mythologize?&quot;
                </blockquote>
                ...
                <p>
                    ...
                    The framework measures directional value — whether a claim
                    advances understanding or adds noise.
                </p>
                <ul className="list-disc pl-5 space-y-2 text-gray-400">
                    ...
                    <li>
                        <strong>Low FVS:</strong> Vague assertions, unfalsifiable predictions,
                        or recycled narratives without new information.
                    </li>
                    <li>
                        The scoring system tracks contributor credibility over time,
                        similar to prediction market reputation systems.
                    </li>
                </ul>
