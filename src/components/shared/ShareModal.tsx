      ...
      <div className="bg-panel w-full max-w-lg border border-border rounded-lg shadow-2xl flex flex-col scale-100 animate-slide-up">
        ...
        <div className="p-6">
          ...
          <div className="bg-background border border-border rounded p-1 flex items-center gap-2">
            ...
            <button
              onClick={handleCopy}
              className={`px-4 py-2 rounded text-xs font-bold uppercase transition-all flex items-center gap-2 ${
                copied
          ...
          <div className="mt-6 flex flex-col gap-2">
            ...
            <div className="flex gap-4">
              <a
                ...
                className="p-3 bg-white/5 rounded hover:bg-white/10 text-white transition-colors"
              >
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
